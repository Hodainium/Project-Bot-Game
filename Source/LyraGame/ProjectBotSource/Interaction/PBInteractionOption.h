...
#include "PBInteractionOption.generated.h"
...
public:
	...
	TScriptInterface<IPBInteractableTarget> InteractableTarget;
...
public:
	FORCEINLINE bool operator==(const FPBInteractionOption& Other) const
	{
